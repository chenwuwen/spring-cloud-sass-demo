...
-- ----------------------------
INSERT INTO `tenant_biz` VALUES (1, '物美业务1', '物美业务说明1');
INSERT INTO `tenant_biz` VALUES (2, '物美业务2', '物美业务说明2');
...
CREATE TABLE `tenant_user`  (
  ...
  `REGISTER_DATE` bigint(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `tenant_user` VALUES (1, 'wm_kanyun', 'kanyun1', NULL);
