...
public class YmlUtils {
    public static String bootstrap_file = "bootstrap.yml";
    public static String application_file = "application.yml";
    ...
    /**
     * 获取application.yml的name
     *
     * @return
     */
    public static String getApplicationName() {
        return getYmlByFileName(application_file).get("spring.application.name");
    }
